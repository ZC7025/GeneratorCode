...
import com.zc.used.common.ServerResponse;
...
public interface BaseService {
     ...
     */
    ServerResponse<Integer> save(Object dataTransferObj);

    /**
     * 根据DTO实体类从数据库中删除数据
     * @param dataTransferObj DTO数据传输对象
     */
    ServerResponse<Integer> remove(Object dataTransferObj);

    /**
     * 根据主键从数据库中删除数据
     * @param id 主键ID
     */
    ServerResponse<Integer> removeById(Serializable id);

    /**
     * 根据多个主键批量删除数据
     * @param ids 多个主键组成的数组
     */
    ServerResponse<Integer> removeByIds(Serializable[] ids);

    /**
     * 根据对象更新数据库中的数据
     * @param dataTransferObj DTO数据传输对象
     */
    ServerResponse<Integer> update(Object dataTransferObj);

    /**
     * 根据StatusQuery查询对象更新is_active状态值
     * @param statusQuery 状态查询对象，包括id和status
     */
    ServerResponse<Integer> updateActiveStatus(StatusQuery statusQuery);
